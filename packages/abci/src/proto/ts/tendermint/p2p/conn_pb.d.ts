...
export declare class PacketPing extends Message<PacketPing> {
	...
	static equals(
		a: PacketPing | PlainMessage<PacketPing> | undefined,
		b: PacketPing | PlainMessage<PacketPing> | undefined,
	): boolean;
}
...
export declare class PacketPong extends Message<PacketPong> {
	...
	static equals(
		a: PacketPong | PlainMessage<PacketPong> | undefined,
		b: PacketPong | PlainMessage<PacketPong> | undefined,
	): boolean;
}
...
export declare class PacketMsg extends Message<PacketMsg> {
	...
	static equals(
		a: PacketMsg | PlainMessage<PacketMsg> | undefined,
		b: PacketMsg | PlainMessage<PacketMsg> | undefined,
	): boolean;
}
...
export declare class AuthSigMessage extends Message<AuthSigMessage> {
	...
	static equals(
		a: AuthSigMessage | PlainMessage<AuthSigMessage> | undefined,
		b: AuthSigMessage | PlainMessage<AuthSigMessage> | undefined,
	): boolean;
}
