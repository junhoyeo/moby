...
import type {
	...
	Part,
	PartSetHeader,
	Proposal as Proposal$1,
	SignedMsgType,
	Vote as Vote$1,
} from '../types/types_pb.js';
...
export declare class NewRoundStep extends Message$1<NewRoundStep> {
	...
	static equals(
		a: NewRoundStep | PlainMessage<NewRoundStep> | undefined,
		b: NewRoundStep | PlainMessage<NewRoundStep> | undefined,
	): boolean;
}
...
export declare class NewValidBlock extends Message$1<NewValidBlock> {
	...
	static equals(
		a: NewValidBlock | PlainMessage<NewValidBlock> | undefined,
		b: NewValidBlock | PlainMessage<NewValidBlock> | undefined,
	): boolean;
}
...
export declare class ProposalPOL extends Message$1<ProposalPOL> {
	...
	static equals(
		a: ProposalPOL | PlainMessage<ProposalPOL> | undefined,
		b: ProposalPOL | PlainMessage<ProposalPOL> | undefined,
	): boolean;
}
...
export declare class BlockPart extends Message$1<BlockPart> {
	...
	static equals(
		a: BlockPart | PlainMessage<BlockPart> | undefined,
		b: BlockPart | PlainMessage<BlockPart> | undefined,
	): boolean;
}
...
export declare class HasVote extends Message$1<HasVote> {
	...
	static equals(
		a: HasVote | PlainMessage<HasVote> | undefined,
		b: HasVote | PlainMessage<HasVote> | undefined,
	): boolean;
}
...
export declare class VoteSetMaj23 extends Message$1<VoteSetMaj23> {
	...
	static equals(
		a: VoteSetMaj23 | PlainMessage<VoteSetMaj23> | undefined,
		b: VoteSetMaj23 | PlainMessage<VoteSetMaj23> | undefined,
	): boolean;
}
...
export declare class VoteSetBits extends Message$1<VoteSetBits> {
	...
	static equals(
		a: VoteSetBits | PlainMessage<VoteSetBits> | undefined,
		b: VoteSetBits | PlainMessage<VoteSetBits> | undefined,
	): boolean;
}
