...
export declare class SnapshotsRequest extends Message$1<SnapshotsRequest> {
	...
	static equals(
		a: SnapshotsRequest | PlainMessage<SnapshotsRequest> | undefined,
		b: SnapshotsRequest | PlainMessage<SnapshotsRequest> | undefined,
	): boolean;
}
...
export declare class SnapshotsResponse extends Message$1<SnapshotsResponse> {
	...
	static equals(
		a: SnapshotsResponse | PlainMessage<SnapshotsResponse> | undefined,
		b: SnapshotsResponse | PlainMessage<SnapshotsResponse> | undefined,
	): boolean;
}
...
export declare class ChunkRequest extends Message$1<ChunkRequest> {
	...
	static equals(
		a: ChunkRequest | PlainMessage<ChunkRequest> | undefined,
		b: ChunkRequest | PlainMessage<ChunkRequest> | undefined,
	): boolean;
}
...
export declare class ChunkResponse extends Message$1<ChunkResponse> {
	...
	static equals(
		a: ChunkResponse | PlainMessage<ChunkResponse> | undefined,
		b: ChunkResponse | PlainMessage<ChunkResponse> | undefined,
	): boolean;
}
