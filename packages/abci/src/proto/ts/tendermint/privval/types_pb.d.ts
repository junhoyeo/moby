...
export declare class RemoteSignerError extends Message$1<RemoteSignerError> {
	...
	static equals(
		a: RemoteSignerError | PlainMessage<RemoteSignerError> | undefined,
		b: RemoteSignerError | PlainMessage<RemoteSignerError> | undefined,
	): boolean;
}
...
export declare class PubKeyRequest extends Message$1<PubKeyRequest> {
	...
	static equals(
		a: PubKeyRequest | PlainMessage<PubKeyRequest> | undefined,
		b: PubKeyRequest | PlainMessage<PubKeyRequest> | undefined,
	): boolean;
}
...
export declare class PubKeyResponse extends Message$1<PubKeyResponse> {
	...
	static equals(
		a: PubKeyResponse | PlainMessage<PubKeyResponse> | undefined,
		b: PubKeyResponse | PlainMessage<PubKeyResponse> | undefined,
	): boolean;
}
...
export declare class SignVoteRequest extends Message$1<SignVoteRequest> {
	...
	static equals(
		a: SignVoteRequest | PlainMessage<SignVoteRequest> | undefined,
		b: SignVoteRequest | PlainMessage<SignVoteRequest> | undefined,
	): boolean;
}
...
export declare class SignedVoteResponse extends Message$1<SignedVoteResponse> {
	...
	static equals(
		a: SignedVoteResponse | PlainMessage<SignedVoteResponse> | undefined,
		b: SignedVoteResponse | PlainMessage<SignedVoteResponse> | undefined,
	): boolean;
}
...
export declare class SignProposalRequest extends Message$1<SignProposalRequest> {
	...
	static equals(
		a: SignProposalRequest | PlainMessage<SignProposalRequest> | undefined,
		b: SignProposalRequest | PlainMessage<SignProposalRequest> | undefined,
	): boolean;
}
...
export declare class SignedProposalResponse extends Message$1<SignedProposalResponse> {
	...
	static equals(
		a:
			| SignedProposalResponse
			| PlainMessage<SignedProposalResponse>
			| undefined,
		b:
			| SignedProposalResponse
			| PlainMessage<SignedProposalResponse>
